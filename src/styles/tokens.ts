// Design Tokens - TypeScript version for programmatic use
...
export const statusColors = {
  created: 'bg-secondary-100 text-secondary-800',
  released: 'bg-primary-100 text-primary-800',
  ...
  offline: 'bg-secondary-100 text-secondary-800',
